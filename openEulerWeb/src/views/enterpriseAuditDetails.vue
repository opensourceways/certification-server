<template>
  <div class="enterpriseAuditDetails">
    <div class="content">
      <div class="title">
        <span style="color: #555555" @click="goBackAll" class="cursor"
      ...
      <div class="main">
        ...
        >
          ...
          <div class="verification">
            <img :src="require('@/assets/images/greenSuccess.png')" alt />
            <span style="font-size: 14px; color: #5a9b83; margin: 0 10px"
              >企业工商注册信息系统校验已通过</span
            >
            <el-popover
              placement="right"
              width="400"
